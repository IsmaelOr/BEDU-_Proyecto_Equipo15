...
Así, queremos estudiar si se cumple que la probabilidad conjunta sea igual al producto de las probabilidades marginales, es decir, si    h<sub>&theta;</sub>(x) = f(x,y)=f(x) * f(y).
